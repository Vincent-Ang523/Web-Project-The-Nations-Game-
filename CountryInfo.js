...
const Ethiopia={
  Name: "Ethiopia",
  Language:['Afar','Amharic','Tigrinya','Oromo','Somali'],
  flagDesign:"",
  flagColors:['Blue','Red','Yellow','Green'],
...
const Seychelles={
  Name: "Seychelles",
  Language:['French','English','Seychellois'],
  flagDesign:"",
...
const SouthAfrica={
  Name: "South Africa",
  Language:['English','Afrikaans','Zulu','Xhosa','Swazi','Sepedi','Sesotho','Setswana','Xitsonga','Tshivenda','Ndebele'],
  flagDesign:"tricolor",
...
const Zimbabwe={
  Name: "Zimbabwe",
  Language:['English','Chewa','Chibarwe','Kalanga','Koisan','Nambya','Ndau','Ndebele','Shangani','Shona','Sotho','Tonga','Tswana','Venda','Xhosa'],
  flagDesign:"",
